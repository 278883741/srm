    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse,
                ...
                tAudio, tFlash, tObject, tPdf, tDoc, tDocx, tEml, tOther, tZoomCache, vDefaultDim;
            tMain1 = '{preview}\n' +
            ...
            tFooter = '{progress} {indicator} {actions}';
            tActions = '{drag}\n' +
            ...
            tEml = '<div align="center" style=" overflow:hidden;line-height:210px;vertical-align:middle;"><a href="{data}">请点击下载eml文件查看</a></div>\n';
            tDoc = '<div align="center" style=" overflow:hidden;line-height:210px;vertical-align:middle;" ><a href="{data}">请点击下载Doc文件查看</a></div>\n';
            tDocx = '<div align="center" style=" overflow:hidden;line-height:210px;vertical-align:middle;"><a href="{data}">请点击下载Docx文件查看</a></div>\n';
            ...
            self.defaults = {
                ...
                allowedPreviewTypes: ['image', 'html', 'text', 'video', 'audio', 'flash', 'pdf', 'doc', 'docx', 'eml', 'object'],
                previewTemplates: {},
                previewSettings: {
                    ...
                    doc: {width: "160px", height: "160px"},
                    docx: {width: "160px", height: "160px"},
                    eml: {width: "160px", height: "160px"},
                ...
                fileTypeSettings: {
                    ...
                    doc: function (vType, vName) {
                        return $h.compare(vType, 'application/doc', true) || $h.compare(vName, /\.(doc)$/i);
                    },
                    docx: function (vType, vName) {
                        return $h.compare(vType, 'application/docx', true) || $h.compare(vName, /\.(docx)$/i);
                    },
                    eml: function (vType, vName) {
                        return $h.compare(vType, 'application/eml', true) || $h.compare(vName, /\.(eml)$/i);
                    },
                    object: function () {
                        return true;
                    },
        ...
        _initPreviewTemplates: function () {
            ...
            $.each(cfg.previewContentTemplates, function (key, value) {
                if ($h.isEmpty(self.previewTemplates[key])) {
                    ...
                    if (key === 'generic' || key === 'image' || key === 'html' || key === 'text' || key === 'doc' || key === 'docx') {
